...
<center>
    ...
    <form class="signup" style="margin-top: 300px;" method="post">
        ...
        <h2 class="votinghead">GIVE YOUR VOTE TO THE FOLLOWING CANDIDATES OF IT FIRST YEAR</h2>
    
            <label for="vote">Deepak Sharma</label>
            <input type="radio" id="vote" name="ce1" value="13">
            <br><br>

            <label for="vote">Pooja Choudhary</label>
            <input type="radio" id="vote" name="ce1" value="14">
            <br><br>

            <label for="vote">Amit Verma</label>
            <input type="radio" id="vote" name="ce1" value="15">
            <br><br>

            <label for="vote">Divya Singhania</label>
            <input type="radio" id="vote" name="ce1" value="16">
            <br><br>

            <label for="vote">Arjun Kapoor</label>
            <input type="radio" id="vote" name="ce1" value="17">
            <br><br>

            <label for="vote">Ananya Gupta</label>
            <input type="radio" id="vote" name="ce1" value="18">
            <br><br>
<br >
...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] === "vote" || $_SESSION['loggedin']==="adm" || $_SESSION['loggedin'] !== "it1voters" ){
