...
<center>
    ...
    <form class="signup" style="margin-top: 300px;" method="post">
        ...
        <h2 class="votinghead">GIVE YOUR VOTE TO THE FOLLOWING CANDIDATES OF CE FIRST YEAR</h2>
    
            <label for="vote">Aditi Patel</label>
            <input type="radio" id="vote" name="ce1" value="1">
            <br><br>

            <label for="vote">Rahul Sharma</label>
            <input type="radio" id="vote" name="ce1" value="2">
            <br><br>

            <label for="vote">Neha Gupta</label>
            <input type="radio" id="vote" name="ce1" value="3">
            <br><br>

            <label for="vote">Kiran Singh</label>
            <input type="radio" id="vote" name="ce1" value="4">
            <br><br>

            <label for="vote">Priya Mehta</label>
            <input type="radio" id="vote" name="ce1" value="5">
            <br><br>

            <label for="vote">Rajesh Kumar</label>
            <input type="radio" id="vote" name="ce1" value="6">
            <br><br>
<br >
...
<?php
    ...
    if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] === "vote" || $_SESSION['loggedin']==="adm" || $_SESSION['loggedin'] !== "ce1voters" ){
