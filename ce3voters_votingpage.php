...
<center>
    ...
    <form class="signup" style="margin-top: 300px;" method="post">
        ...
        <h2 class="votinghead">GIVE YOUR VOTE TO THE FOLLOWING CANDIDATES OF CE THIRD YEAR</h2>
    
            <label for="vote">Rohit Patel</label>
            <input type="radio" id="vote" name="ce1" value="37">
            <br><br>

            <label for="vote">Anita Sharma</label>
            <input type="radio" id="vote" name="ce1" value="38">
            <br><br>

            <label for="vote">Amit Gupta</label>
            <input type="radio" id="vote" name="ce1" value="39">
            <br><br>

            <label for="vote">Kavita Singh</label>
            <input type="radio" id="vote" name="ce1" value="40">
            <br><br>

            <label for="vote">Nitin Mehta</label>
            <input type="radio" id="vote" name="ce1" value="41">
            <br><br>

            <label for="vote">Kumar Kumar</label>
            <input type="radio" id="vote" name="ce1" value="42">
            <br><br>
<br >
...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] === "vote" || $_SESSION['loggedin']==="adm" || $_SESSION['loggedin'] !== "ce3voters" ){
