...
<center>
    ...
    <form class="signup" style="margin-top: 300px;" method="post">
        ...
        <h2 class="votinghead">GIVE YOUR VOTE TO THE FOLLOWING CANDIDATES OF IT SECOND YEAR</h2>
    
            <label for="vote">Kartik Sharma</label>
            <input type="radio" id="vote" name="ce1" value="31">
            <br><br>

            <label for="vote">Anjali Choudhary</label>
            <input type="radio" id="vote" name="ce1" value="32">
            <br><br>

            <label for="vote">Aryan Verma</label>
            <input type="radio" id="vote" name="ce1" value="33">
            <br><br>

            <label for="vote">Divya Singhania</label>
            <input type="radio" id="vote" name="ce1" value="34">
            <br><br>

            <label for="vote">Vishal Kapoor</label>
            <input type="radio" id="vote" name="ce1" value="35">
            <br><br>

            <label for="vote">Sneha Gupta</label>
            <input type="radio" id="vote" name="ce1" value="36">
            <br><br>
<br >
...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] === "vote" || $_SESSION['loggedin']==="adm" || $_SESSION['loggedin'] !== "it2voters" ){
