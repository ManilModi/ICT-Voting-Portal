...
<center>    
  ...
  <div class="reg_form">
    ...
    <form  method="post">
        ...
        <input type="radio" id="CE" name="system" value="adm" required>
        <label for="ce">Admins</label>
        <input type="radio" id="EC" name="system" value="vote">
        <label for="ec">Voters</label><br>
        
         <input class="signup" name="submit" type="submit" value="Login"><br><br>
